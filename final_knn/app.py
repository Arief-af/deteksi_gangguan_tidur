...
try:
    model = joblib.load('model/knn_model.pkl') # Changed model file path
    ...
    print("Error: Pastikan 'knn_model.pkl', 'scaler.pkl', 'label_encoder.pkl', dan 'model_features.pkl' ada di direktori 'model/'.")
...
# Removed the feature importance endpoint as KNN does not provide feature importances.
